...
length_dist <- ggplot(metrics[scaffolded == 'scaffolds' & superkingdom != 'Eukaryota' & superkingdom != '' & superkingdom != 'not classified'],
...
For further taxonomy stuff, refer to the R shiny app.
