...
bincol_plot_anvio <- bincol_plot_anvio + geom_bar(aes(y= percent_completion,
                                          x=rank),
                                      stat='identity',
                                      fill='darkgreen'
                                      )
...
bincol_plot_checkm <- bincol_plot_checkm + geom_bar(aes(y= Completeness,
                                          x=rankCM),
                                      stat='identity',
                                      fill='darkgreen'
                                      )
...
# facets
bincol_plot_notaxsupport <- bincol_plot_notaxsupport + facet_grid(Sample ~ taxlevel)
bincol_plot_notaxsupport <- bincol_plot_notaxsupport + scale_fill_brewer(type = 'qual',palette = 2)

# make it pretty
bincol_plot_notaxsupport <- bincol_plot_notaxsupport + theme_classic()
bincol_plot_notaxsupport <- bincol_plot_notaxsupport + xlab('Binning method') + ylab('Count of bins without taxonomy assigned')
