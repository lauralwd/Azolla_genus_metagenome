...
bincol_plot <- bincol_plot + geom_text(data=bincolcountAnvio9010,
                                       aes(y=99,
                                           x=22,
                                           label=count)
                                       ,col='darkgreen')
...
# facets
bincol_plot <- bincol_plot + facet_grid(Sample ~ Collection)
...
bincol_plot <- bincol_plot + geom_text(data=bincolcountCheckM9010,
                                       aes(y=99,
                                           x=22,
                                           label=count)
                                       ,col='darkgreen')
