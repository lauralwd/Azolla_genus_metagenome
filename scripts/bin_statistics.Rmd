...
bincol_plot <- bincol_plot + geom_bar(aes(y= percent_completion,x=rank),stat='identity',fill='darkgreen')
bincol_plot <- bincol_plot + geom_bar(aes(y=-percent_redundancy,x=rank),stat='identity',fill='red')
bincol_plot <- bincol_plot + geom_text(data=bincolcount,
                                       aes(y=90,x=15,label=count))
